...
/**
 * This is a widget with the related immo based on tags
 *
...
class Related extends FrontendBaseWidget
{
	...
	private function getRelated()
	{
        ...
        foreach($this->related as $id => $entry) {
            $immoIds[] = $entry['other_id'];
        }

        $immo = FrontendImmoModel::getImmoByIds($immoIds);
        if ($immo) {
            // only show 3
            $this->related = array_splice($immo, 0, 3);
            return;
        }
