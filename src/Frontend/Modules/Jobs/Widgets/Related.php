...
/**
 * This is a widget with the related jobs based on tags
 *
...
class Related extends FrontendBaseWidget
{
	...
	private function getRelated()
	{
        ...
        foreach($this->related as $id => $entry) {
            $jobsIds[] = $entry['other_id'];
        }

        $jobs = FrontendJobsModel::getJobsByIds($jobsIds);
        if ($jobs) {
            // only show 3
            $this->related = array_splice($jobs, 0, 3);
            return;
        }
