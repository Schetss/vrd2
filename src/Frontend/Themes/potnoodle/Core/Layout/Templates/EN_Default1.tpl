	...
	<main id="main" class="holder main-holder" role="main">
		<div class="main-header">
			...
			<nav id="selector2">
				<ul>
					<li>
						<a href="/en/the-company/distribution">Distribution</a>
					</li>
					<li>
						<a href="/en/the-company/transport">Transport</a>
					</li>
					<li>
						<a href="/en/the-company/storage-order-picking">Storage &amp; order picking</a>
					</li>
					<li>
						<a href="/en/the-company/immo">Immo</a>
					</li>
				</ul>
			</nav>
