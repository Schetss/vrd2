	...
	<main id="main" class="holder main-holder" role="main">
		<div class="main-header">
			...
			<nav id="selector2">
				<ul>
					<li>
						<a href="/fr/l-entreprise/distribution">Distribution</a>
					</li>
					<li>
						<a href="/fr/l-entreprise/transport">Transport</a>
					</li>
					<li>
						<a href="/fr/l-entreprise/stockage">Stockage</a>
					</li>
					<li>
						<a href="/fr/l-entreprise/immo">Immo</a>
					</li>
				</ul>
			</nav>
