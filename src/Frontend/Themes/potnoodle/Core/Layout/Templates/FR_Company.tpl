		...
		<section class="page1">
			<div class="page-container">
				<div class="comp-text-1">
					...
					<div class="comp-nav">
						<ul>
							<li><a href="/fr/l-entreprise/distribution">Distributie</a></li>
							<li><a href="/fr/l-entreprise/transport">Transport</a></li>
							<li><a href="/fr/l-entreprise/stockage">Opslag en fijnpicking</a></li>
							<li><a href="/fr/l-entreprise/immo">Immo</a></li>
						</ul>
					</div>
				</div>
