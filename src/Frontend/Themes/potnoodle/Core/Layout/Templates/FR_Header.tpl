		...
		<div class="header">
			...
			<div class="inner-header">
				<div class="inner-inner-header row">
					<a href="{$SITE_URL}/fr"><img class="logo retina" alt="{$siteTitle}" src="/src/Frontend/Core/Layout/images/logo.png" /></a>
	                <p class="slogan">Votre partenaire en stockage, distribution et location!</p>
