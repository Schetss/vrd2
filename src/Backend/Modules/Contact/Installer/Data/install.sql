DROP TABLE IF EXISTS `contact_albums`, `contact_categories`, `contact_albums_tracks`;

CREATE  TABLE IF NOT EXISTS `contact_albums` (
...
CREATE  TABLE IF NOT EXISTS `contact_albums_tracks` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
