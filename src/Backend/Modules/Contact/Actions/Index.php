...
/**
 * This is the index-action (default), it will display the overview of contact posts
 *
...
class Index extends BackendBaseActionIndex
{
    ...
    {
        // create datagrid
        $this->dataGrid = new BackendDataGridDB(BackendContactModel::QRY_DATAGRID_BROWSE);
        ...
        $this->dataGrid->setColumnFunction(array(new BackendContactModel(), 'getCoverImageThumb'), array('[id]', $this->getModule()), 'cover', true);
        $this->dataGrid->setColumnFunction(array(new BackendContactModel(), 'getMonthYearDate'), array('[date]'), 'date', true);
