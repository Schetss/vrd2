...
class Edit extends BackendBaseActionEdit
{
    ...
    protected function getData()
    {
        ...
        // Get tracks
        $this->tracks = (array) BackendContactModel::getTracks($this->id);
    ...
    protected function validateForm()
    {
        if($this->frm->isSubmitted()) {
            ...
            if($this->frm->isCorrect()) {
                ...
                // update the item
                BackendContactModel::update($this->id, $item);
                $item['id'] = $this->id;
                ...
                foreach($tracks as $i => $track) {
                    ...
                    if(!empty($track['id'])) {
                        BackendContactModel::updateTrack(
                            array(
                                'id' => $track['id'],
                                'title' => $track['track'],
                    ...
                    // new track
                        ...
                        BackendContactModel::insertTrack(
                            array(
                                'album_id' => $this->id,
                                'title' => $track['track'],
                                'duration' => $track['duration'],
                ...
                foreach($this->tracks as $track) {
                    ...
                    if(!in_array($track['id'], $updatedTracks)) {
                        BackendContactModel::deleteTrack($track['id']);
                    }
                }
