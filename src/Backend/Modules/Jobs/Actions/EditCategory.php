...
class EditCategory extends BackendBaseActionEdit
{
	...
	{
		$this->record = BackendJobsModel::getCategory($this->id);
	}
	...
	protected function parse()
	{
		...
		$this->tpl->assign('showJobsDeleteCategory', BackendJobsModel::deleteCategoryAllowed($this->id) && BackendAuthentication::isAllowedAction('delete_category'));
	}
	...
	private function validateForm()
	{
		...
		{
			$this->meta->setUrlCallback('Backend\Modules\Jobs\Engine\Model', 'getURLForCategory', array($this->record['id']));
			...
			if($this->frm->isCorrect())
			{
				...
				// update the item
				BackendJobsModel::updateCategory($item);
