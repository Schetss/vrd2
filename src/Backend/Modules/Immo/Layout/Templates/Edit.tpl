...
<div class="pageTitle">
	<h2>{$lblImmo|ucfirst}: {$msgEditImmo|sprintf:{$item.title}}</h2>
</div>

{form:edit}

	<label for="title">{$lblImmo|ucfirst}</label>
				...
				<tr>
					...
					<td id="sidebar">
						...
						<div id="publishOptions" class="box">
							...
							<div class="options">
								<label for="spotlight">{$msgRelatedImmo}</label></br>
								{$ddmRelatedImmo} {$ddmRelatedImmoError}
							</div>
						</div>
					</td>
				</tr>
