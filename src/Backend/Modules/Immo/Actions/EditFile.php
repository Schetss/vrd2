...
/**
 * This is the edit file action, it will display a form to edit an existing immo file.
 *
...
class EditFile extends BackendBaseActionEdit
{
	...
	public function execute()
	{
		...
		if($this->id !== null && BackendImmoModel::existsFile($this->id))
		{
			parent::execute();
	...
	protected function getData()
	{
		...
		$this->file = BackendImmoModel::getFile($this->getParameter('id', 'int'));
	...
	protected function validateForm()
	{
		...
		if($this->frm->isSubmitted())
		{
			...
			if($this->frm->isCorrect())
			{
				...
				// the file path
				$filePath = FRONTEND_FILES_PATH . '/' . $this->getModule() . '/' . $this->immo['id'] . '/source';
				...
				// save the item
				$id = BackendImmoModel::saveFile($item);
