...
/**
 * This is the edit video action, it will display a form to edit an existing immo video.
 *
...
class EditVideo extends BackendBaseActionEdit
{
	...
	public function execute()
	{
		...
		if($this->id !== null && BackendImmoModel::existsVideo($this->id))
		{
			parent::execute();
	...
	protected function getData()
	{
		...
		$this->video = BackendImmoModel::getVideo($this->getParameter('id', 'int'));
	...
	protected function validateForm()
	{
		...
		if($this->frm->isSubmitted())
		{
			...
			if($this->frm->isCorrect())
			{
				...
				// save the item
				$id = BackendImmoModel::saveVideo($item);
